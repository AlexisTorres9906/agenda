...
export const Finalizado = () => {
  ...
  const FormikPropsChildren: FormikConfig<FormikValues> = {
    ...
    validationSchema: Yup.object({
      fechaRCierre: Yup.date()
        .required("Por favor ingrese la fecha de cierre del acuerdo")
        .nullable(),
              ...
              <Form>
                <div className="mb-3">
                  ...
                  <DatePickerField
                    ...
                    minDate={
                     typeof activeAcuerdo?.fechaIEjecucion === "string" ? new Date(activeAcuerdo?.fechaIEjecucion) : activeAcuerdo?.fechaIEjecucion
                    }
                  />
                  <div style={{ color: "red" }}>
